...
<body class="antialiased mx-auto bg-[#111827] text-white">
  <div class="flex h-screen">
    ...
    <aside class="w-[28%] h-screen relative overflow-y-auto pl-28 text-white bg-[#111523]">
      <div class="w-[224px] ml-auto mr-0 relative">
        @yield('sidebar')
      </div>
    </aside>
  
    <main x-data="{ flash: true }" class="w-[72%] h-full overflow-y-auto pl-12 mr-auto">
      <div class="w-[870px]">
        <x-navbar></x-navbar>
        @guest
        <x-greet></x-greet>
